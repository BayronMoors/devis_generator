...
export default function Login({}: Props) {
  return (
    // <div classNameName='text-white'>Login</div>
<section className="py-20 lg:py-[20px]">
  <div className="container mx-auto">
    <div className="-mx-4 flex flex-wrap">
      <div className="w-full px-4">
        <div
          className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white dark:bg-gray-700 py-16 px-10 text-center sm:px-12 md:px-[60px]"
        >
          ...
          <form>
            ...
            <div className="mb-10">
              <input
                type="submit"
                value="Sign In"
                className="bordder-primary w-full cursor-pointer rounded-md border bg-primary py-3 px-5 text-base text-gray-600 dark-text transition hover:bg-opacity-90"
              />
            </div>
          </form>
